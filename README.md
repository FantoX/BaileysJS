...
## What is different in this version of Baileys?

Baileys has an ***503 - Service Unavailable*** error that I was facing while using it. This version of Baileys doesn't have that error. It is originally [WhiskeySockets/Baileys v-6.2.1](https://github.com/WhiskeySockets/Baileys). I have just made some small changes to it. So almost everythong is same as official version.

## Credits

Check out official contributors of [WhiskeySockets/Baileys](https://github.com/WhiskeySockets/Baileys/graphs/contributors)

## Example

Do check out & run [example.ts](https://github.com/WhiskeySockets/Baileys/blob/master/Example/example.ts) to see an example usage of the library.
...
```
yarn add github:FantoX/BaileysJS
```

Then import your code using:
``` ts 
import makeWASocket from 'baileysjs'
```
...
``` ts
import makeWASocket, { DisconnectReason } from 'baileysjs'
...
``` ts
import makeWASocket, { BufferJSON, useMultiFileAuthState } from 'baileysjs'
...
``` ts
import makeWASocket, { makeInMemoryStore } from 'baileysjs'
...
``` ts
import { MessageType, MessageOptions, Mimetype } from 'baileysjs'
...
- **MiscGenerationOptions**: some extra info about the message. It can have the following __optional__ values:
    ...
    const info: MessageOptions = {
        ...
        mimetype: Mimetype.pdf, /* (for media messages) specify the type of media (optional for all media types except documents),
                                    import {Mimetype} from 'baileysjs'
                                */
...
import { downloadMediaMessage } from 'baileysjs'
